...
public class Ripemd160Util {
	...
	/**
	 * Computes and returns a 20-byte (160-bit) hash of the specified binary
	 * message. Each call will return a new byte array object instance.
	 * 
	 * @param msg
	 *            the message to compute the hash of
	 * @return a 20-byte array representing the message's RIPEMD-160 hash
	 * @throws NullPointerException
	 *             if the message is {@code null}
	 */
	...
	private static final int[] KL = { 0x00000000, 0x5A827999, 0x6ED9EBA1, 0x8F1BBCDC, 0xA953FD4E }; // Round constants
																									// for left line
	private static final int[] KR = { 0x50A28BE6, 0x5C4DD124, 0x6D703EF3, 0x7A6D76E9, 0x00000000 }; // Round constants
																									// for right line
	...
	private Ripemd160Util() {} // Not instantiable
}
