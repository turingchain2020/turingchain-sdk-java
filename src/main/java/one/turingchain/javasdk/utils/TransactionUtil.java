...
import one.turingchain.javasdk.model.enums.WasmEnum;
...
import one.turingchain.javasdk.model.Address;
import one.turingchain.javasdk.model.Signature;
import one.turingchain.javasdk.model.Transaction;
import one.turingchain.javasdk.model.TransferBalanceRequest;
import one.turingchain.javasdk.model.decode.DecodeRawTransaction;
import one.turingchain.javasdk.model.enums.SignType;
import one.turingchain.javasdk.model.gm.SM2KeyPair;
import one.turingchain.javasdk.model.gm.SM2Util;
import one.turingchain.javasdk.model.protobuf.ManageProtobuf.ManageAction;
import one.turingchain.javasdk.model.protobuf.ManageProtobuf.ModifyConfig.Builder;
import one.turingchain.javasdk.model.protobuf.TokenActionProtoBuf.TokenAction;
import one.turingchain.javasdk.model.protobuf.TokenActionProtoBuf.TokenFinishCreate;
import one.turingchain.javasdk.model.protobuf.TokenActionProtoBuf.TokenPreCreate;
import one.turingchain.javasdk.model.protobuf.TransactionAllProtobuf.AssetsTransfer;
...
public class TransactionUtil {
    ...
    public static String createManage(String key, String value, String op, String privateKey, String execer) {
        ...
        one.turingchain.javasdk.model.protobuf.ManageProtobuf.ManageAction.Builder actionBuilder = ManageProtobuf.ManageAction.newBuilder();
	...
	public static byte[] createtTokenTransferPayLoad(String to, Long amount, String coinToken, String note) {
		...
		assetsTransferBuilder.setTo(to);
		one.turingchain.javasdk.model.protobuf.TokenActionProtoBuf.AssetsTransfer assetsTransfer = assetsTransferBuilder.build();
		TokenActionProtoBuf.TokenAction.Builder tokenActionBuilder = TokenActionProtoBuf.TokenAction.newBuilder();
