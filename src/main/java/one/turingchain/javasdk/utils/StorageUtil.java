package one.turingchain.javasdk.utils;

import one.turingchain.javasdk.model.protobuf.TransactionAllProtobuf;
import com.google.protobuf.ByteString;
import com.google.protobuf.InvalidProtocolBufferException;

import one.turingchain.javasdk.model.enums.StorageEnum;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf;
import one.turingchain.javasdk.model.protobuf.TransactionAllProtobuf;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf.ContentOnlyNotaryStorage.Builder;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf.EncryptNotaryStorage;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf.EncryptShareNotaryStorage;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf.HashOnlyNotaryStorage;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf.LinkNotaryStorage;
import one.turingchain.javasdk.model.protobuf.StorageProtobuf.StorageAction;
...
public class StorageUtil {
    ...
    public static String createOnlyNotaryStorage(byte[] content, String execer, String privateKey) {
        ...
        one.turingchain.javasdk.model.protobuf.StorageProtobuf.StorageAction.Builder storageActionBuilder = StorageProtobuf.StorageAction.newBuilder();
    ...
    public static String createHashStorage(byte[] hash, String execer, String privateKey) {
        one.turingchain.javasdk.model.protobuf.StorageProtobuf.HashOnlyNotaryStorage.Builder hashStorageBuilder = StorageProtobuf.HashOnlyNotaryStorage.newBuilder();
    ...
    public static String createLinkNotaryStorage(byte[] link,byte[] hash, String execer, String privateKey) {
        one.turingchain.javasdk.model.protobuf.StorageProtobuf.LinkNotaryStorage.Builder storageBuilder = StorageProtobuf.LinkNotaryStorage.newBuilder();
    ...
    public static String createEncryptNotaryStorage(byte[] encryptContent,byte[] contentHash,byte[] nonce, String key,
        ...
        one.turingchain.javasdk.model.protobuf.StorageProtobuf.EncryptNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptNotaryStorage.newBuilder();
    ...
    public static String createEncryptShareNotaryStorage(byte[] contentHash,byte[] content,byte[] nonce,byte[] keyName,byte[] keyWrap, String execer, String privateKey) {
        one.turingchain.javasdk.model.protobuf.StorageProtobuf.EncryptShareNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptShareNotaryStorage.newBuilder();
        storageBuilder.setContentHash(ByteString.copyFrom(contentHash));
