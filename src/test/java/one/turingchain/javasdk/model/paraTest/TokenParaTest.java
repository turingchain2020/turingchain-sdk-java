...
import one.turingchain.javasdk.model.rpcresult.TokenResult;
...
public class TokenParaTest {
	...
	// 在TRC公链平行链的场合下，地址下需要带有相应的coins，用于支付交易手续费
    ...
    public void getTokenBalace() {
        ...
        queryTrcBalance = client.getTokenBalance(addressList, execer, "COINSDEVX");
