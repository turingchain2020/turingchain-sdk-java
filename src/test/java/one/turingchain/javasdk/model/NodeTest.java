...
// 前置步骤：
// 1. 下载turingchain安装节点，并解压。  wget https://trc33.oss-cn-shanghai.aliyuncs.com/turingchain_consortium.tar.gz
// 2.  生成节点公私钥对  
// ./turingchain-cli valnode init_keyfile -n 1 -t bls
// 3.  公私钥配置
// 上一步成生priv_validator.json和genesis_file.json两个文件
// 		3.1 priv_validator_0.json  -----------> priv_validator.json
//		3.2   删除genesis_file.json，同时从peer0文件夹中，移动genesis.json文件到turingchain_consortium目录下。
