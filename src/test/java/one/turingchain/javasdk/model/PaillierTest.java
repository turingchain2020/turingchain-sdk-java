...
import one.turingchain.javasdk.model.paillier.PaillierCipher;
import one.turingchain.javasdk.model.paillier.PaillierKeyPair;
...
public class PaillierTest {
    ...
    public void paillierStoryTest() throws Exception {
        RpcClient client = new RpcClient("127.0.0.1", 9671);
