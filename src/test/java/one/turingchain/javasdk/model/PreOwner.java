...
import one.turingchain.javasdk.model.pre.EncryptKey;
...
public class PreOwner {
    ...
    // 区块链节点
    static RpcClient turingchainClient = new RpcClient("http://ip:8901");
    ...
    // 待加密的数据
    static String content = "Turingchain 代理重加密测试";
    ...
    public void preEncrypt() {
        ...
        String txEncode = StorageUtil.createEncryptNotaryStorage(cipher, contentHash, iv,
                "turingchain-storage-key-pre-alice2", "", "storage", OwnerPrivateKey);
        String submitTransaction = turingchainClient.submitTransaction(txEncode);
