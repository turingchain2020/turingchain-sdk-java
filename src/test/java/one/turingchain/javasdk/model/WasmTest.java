package one.turingchain.javasdk.model;

import one.turingchain.javasdk.client.Account;
import one.turingchain.javasdk.client.GrpcClient;
...
import one.turingchain.javasdk.model.protobuf.CommonProtobuf;
import one.turingchain.javasdk.model.protobuf.TransactionAllProtobuf;
import one.turingchain.javasdk.model.protobuf.WasmProtobuf;
import one.turingchain.javasdk.utils.*;
...
public class WasmTest {
    ...
    String grpcHost = "127.0.0.1:9672";
    String jsonRpcHost = "http://127.0.0.1:9671";
    GrpcClient javaGrpcClient;
    RpcClient turingchainclient = new RpcClient(jsonRpcHost);
    String execer = "wasm";
    ...
    public void testWasmAll() throws Exception {
        ...
        // 发送交易
        String createHash = turingchainclient.submitTransaction(createTx);
        ...
        // 发送交易
        String callHash = turingchainclient.submitTransaction(callTx);
        ...
        // 发送交易
        String hash = turingchainclient.submitTransaction(transactionHash);
        ...
        // 发送交易
        String oldCallHash = turingchainclient.submitTransaction(oldCallTx);
        ...
        // 发送交易
        String newCallHash = turingchainclient.submitTransaction(newCallTx);
